...
class TrainingCourse(models.Model):
    ...
    _sql_constraints = [
        ...
        ('nama_keterangan_cek', 'CHECK (name != description)', 'Keterangan Kursus tidak boleh sama dengan Nama Kursus.')]
    ...
    level = fields.Selection([('basic', 'dasar'),('advance','lanjutan')], string='Tingkatan', default='basic')
